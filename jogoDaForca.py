...
def marcaChuteCerto(chute, letras_acertadas, palavra_secreta):
    index = 0
...
def jogar():
    ...
    palavra_secreta = carregandoPalavra()
    ...
    while (not enforcou and not acertou):
        ...
        if (chute in palavra_secreta):
            marcaChuteCerto(chute, letras_acertadas, palavra_secreta)
        else:
            erros += 1
            desenha_forca(erros)
